...
<div class="max-w-2xl mx-auto py-8">
    ...
    <div class="bg-white dark:bg-[#1a1f2e] prime:bg-white border border-gray-200 dark:border-[#333d55] prime:border-green-200 rounded-xl overflow-hidden shadow-sm">
        ...
        {{-- Form Body --}}
        <form method="POST" action="{{ route('profile.update') }}" enctype="multipart/form-data" class="px-6 py-5 space-y-5">
            @csrf
            @method('PUT')
            ...
            <div>
                <div class="border-t border-gray-100 dark:border-[#2a3042] prime:border-green-100 pt-5">
                    ...
                    <p class="text-xs text-gray-400 dark:text-gray-500 prime:text-gray-400 mb-3">Leave blank to keep your current password</p>
