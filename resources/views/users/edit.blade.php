...
<div class="max-w-lg mx-auto py-8">
    ...
    <div class="bg-white dark:bg-[#1a1f2e] prime:bg-white border border-gray-200 dark:border-[#333d55] prime:border-green-200 rounded-xl p-6">
        ...
        <form method="POST" action="{{ route('users.update', $user) }}" class="space-y-4">
            ...
            <div class="border-t border-gray-100 dark:border-[#2a3042] prime:border-green-100 pt-4 mt-4">
                ...
                <div class="space-y-3">
                    <div>
                        ...
                        <input type="password" name="password"
                               ...
                               class="w-full px-3 py-2 text-sm rounded-lg border border-gray-200 dark:border-[#333d55] prime:border-green-200 bg-gray-50 dark:bg-[#222736] prime:bg-white text-gray-900 dark:text-gray-100 prime:text-gray-900 placeholder-gray-400 dark:placeholder-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-400 dark:focus:ring-red-500 prime:focus:ring-green-500 transition">
